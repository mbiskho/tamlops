...
from modules.algo import allocate_gpu, real_min_min, real_max_min
...
async def schedule_logic_real_max_min():
    ...
    sorted_tasks = real_max_min(tasks_with_times, dgx_gpu)
